...
if($nombre==""){
    ...
    if($descripcion==""){
        ...
        if(isset($_FILES['imagen'])){
            ...
            $sql="INSERT INTO producto (nomProducto,desProducto,preProducto,estado,imgProducto,tipoProducto,featured)
            VALUES ('$nombre','$descripcion',$precio,$estado,'$nombre_imagen','$tipoprod','$featured')";
